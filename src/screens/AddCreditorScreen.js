...
import { insertCreditor, updateCreditor } from '../storage/database';

export default function AddCreditorScreen({ navigation, route }) {
  ...
  // Input refs for automatic focus stepping
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editing) {
        await updateCreditor(record);
      } else {
        await insertCreditor(record);
      }
      navigation.goBack();
    } catch (e) {
      Alert.alert('Error', 'Could not save creditor.');
    } finally {
      setSaving(false);
    }
  };
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            <View style={styles.field}>
              ...
              <TextInput
                ...
                placeholder="e.g. Ama Serwaa Store"
            ...
            <View style={[styles.field, { borderBottomWidth: 0 }]}>
              ...
              <TextInput
                ...
                placeholder="e.g. Kaneshie Market, Shop 42"
                placeholderTextColor="#e2e8f0"
                returnKeyType="next"
          ...
          <View style={styles.card}>
            <View style={[styles.field, { borderBottomWidth: 0 }]}>
              ...
              <TextInput
                ...
                placeholder="What was this for? Items bought?"
                placeholderTextColor="#e2e8f0"
                multiline
                returnKeyType="done"
        ...
        <TouchableOpacity 
          ...
          disabled={saving}
        >
          <Text style={styles.saveBtnText}>{saving ? 'Saving...' : 'Confirm & Save Creditor'}</Text>
        </TouchableOpacity>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  calendarIconBg: { width: 40, height: 40, borderRadius: 12, backgroundColor: '#fff5f5', justifyContent: 'center', alignItems: 'center' },
